...
class Provider
{
    ...
    /**
     * @return Collection<int, ProviderCategories>
     */
    ...
    public function addCategory(ProviderCategories $category): static
    {
    ...
    public function removeCategory(ProviderCategories $category): static
    {
